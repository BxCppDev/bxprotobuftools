...
#ifndef BXPROTOBUFTOOLS_STD_VECTOR_CONVERTERS_H
#define BXPROTOBUFTOOLS_STD_VECTOR_CONVERTERS_H
...
namespace protobuftools {
  ...
  public:
    ...
    static void protobufize(::protobuftools::message_node & node_, std::vector<T> & x_)
    {
    ...
    static void deprotobufize(message_node & node_, std::vector<T> & x_)
    {
      BX_PROTOBUF_MESSAGE_THROW_IF(! node_.is_field(), message_exception,
                                   node_.get_message(), "Missing field descriptor!");
      const google::protobuf::FieldDescriptor * field_descriptor = node_.get_field_descriptor();
...
#endif // BXPROTOBUFTOOLS_STD_VECTOR_CONVERTERS_H
